...
class ClientHandler(socketserver.BaseRequestHandler):
    def handle(self):
        ...
        with open ("/home/kali/Documents/key/private.key", "rb") as key_file:
        ...
        print(f"Decrypted key: {decryptedSymmetricKey.hex()}")

        self.request.sendall(b"send key back: " + decryptedSymmetricKey)
